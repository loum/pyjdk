...
OPENJDK_11_HEADLESS_MAIN ?= 11.0.19
export OPENJDK_11_HEADLESS_VERSION ?= $(OPENJDK_11_HEADLESS_MAIN)+7~us1-0ubuntu1~22.04.1
...
UBUNTU_BASE_IMAGE ?= loum/python3-ubuntu:jammy-$(PYTHON_MAJOR_MINOR_VERSION)
